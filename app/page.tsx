...
export const metadata:Metadata={title:'AI-продавець для бізнесу: відповідає клієнтам 24/7',description:'AI-продавець веде переписки в Telegram, Instagram, Facebook і на сайті, кваліфікує ліди та записує на зустріч. Безкоштовне демо.',alternates:{canonical:'/'}};
