...
export const metadata={title:'Тарифи',description:'Порівняйте Start, Business і Scale: кількість AI-агентів, ліміти повідомлень, канали та інтеграції. Безкоштовний Demo для першого знайомства.',alternates:{canonical:'/tarify'}};
