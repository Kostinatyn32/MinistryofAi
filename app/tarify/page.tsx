...
export default async function Page(){const market=await getMarket();return <main id="main"><JsonLd faq={billingFaq} path="/tarify" title="Тарифи AI-продавця"/><div className="container"><PageHeading title="Тарифи AI-продавця для бізнесу" description="Почніть із безкоштовного діалогу. Оберіть можливості, коли переконаєтесь у роботі агента."/><Pricing initialMarket={market} full/><section className="section faq-section"><div><span className="section-label">Умови</span><h2>Про тарифи й оплату</h2></div><FAQ items={billingFaq}/></section></div><FinalCTA/></main>}
