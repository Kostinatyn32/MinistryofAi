...
export const metadata:Metadata={metadataBase:new URL('https://ministrysale.org'),title:{default:'AI-продавець у месенджерах | Міністерство з Продажів',template:'%s | Міністерство з Продажів'},description:'AI-агент веде переписку з клієнтами цілодобово: відповідає, кваліфікує, збирає контакти і записує на зустріч. Запуск за 15 хвилин, безкоштовний тест.',robots:process.env.SITE_LIVE==='true'?{index:true,follow:true}:{index:false,follow:false},openGraph:{type:'website',locale:'uk_UA',siteName:'Міністерство з Продажів'},twitter:{card:'summary_large_image'}};
