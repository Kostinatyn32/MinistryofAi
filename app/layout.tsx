...
export const metadata:Metadata={metadataBase:new URL('https://ministrysale.org'),title:{default:'AI-продавець для бізнесу | Міністерство з Продажів',template:'%s | Міністерство з Продажів'},description:'AI-продавець відповідає клієнтам у Telegram, Instagram, Facebook і на сайті, кваліфікує ліди та записує на зустріч 24/7.',robots:process.env.SITE_LIVE==='true'?{index:true,follow:true}:{index:false,follow:false},openGraph:{type:'website',locale:'uk_UA',siteName:'Міністерство з Продажів'},twitter:{card:'summary_large_image'}};
